...
interface IUVCService {
	...
	void takePicture(int serviceId,String path,ITakePictureCallback callback);
	void preview(int serviceId,IPreviewCallback callback);
	void setBrightnessS(int serviceId,int brightness);
    int getBrightnessS(int serviceId);
}