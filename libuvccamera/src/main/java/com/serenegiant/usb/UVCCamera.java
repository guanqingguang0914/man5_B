...
public class UVCCamera {
    ...
    public static final int DEFAULT_PREVIEW_WIDTH = 176;//640;//176
    public static final int DEFAULT_PREVIEW_HEIGHT = 144;//480;//144
    public static final int DEFAULT_PREVIEW_MODE = 0;
    public static final int DEFAULT_PREVIEW_MIN_FPS = 1;
    //public static final int DEFAULT_PREVIEW_MAX_FPS =30;
    //jingh modify
    public static final int DEFAULT_PREVIEW_MAX_FPS = 15;
    public static final float DEFAULT_BANDWIDTH = 4f;
...
//================================================================================
    ...
    /**
     * yangqiang add
     * @param brightness S摄像头调节亮度
     */
    public synchronized void setBrightnessS(final int brightness) {
        if (mNativePtr != 0) {
            final float range = Math.abs(mBrightnessMax - mBrightnessMin);
            if (range > 0)
    ...
    public synchronized int getBrightnessS() {
        int result = 0;
        if (mNativePtr != 0) {
            result = nativeGetBrightness(mNativePtr);
            nativeUpdateBrightnessLimit(mNativePtr);
        }
        return result;
    }
